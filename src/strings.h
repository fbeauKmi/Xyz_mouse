...
const char menu47[] PROGMEM = "Reset config";

// arMenu 
// first byte : pos of menu10 string in PROGMEM array
// other : offpos of menu strings in array + nb of items
const byte arMenu[] PROGMEM = {0x07, 0x01U, 0x0BU} ;
// actions
// Types for each menu items (see Orbion_display::action())
const byte itemsType[] PROGMEM = {KNOBDIR_AM, PANTILT_AM, DZ_WIDTH_AM, SENS_AM, COLOR_AM, COLOR_AM, MOTIONMOD_AM, COLORMODE_AM, CONTRAST_AM, TIMEOUT_AM, RESET_AM} ;
...
const byte minVals[] PROGMEM = {0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00};
const byte maxVals[] PROGMEM = {0x02, 0x13, 0x01, 0x04, 0xFFU, 0x02, 0x03, 0x3C, 0x04, 0x01} ;
